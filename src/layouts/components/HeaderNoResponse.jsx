...
import Header1NopResponse from "./Header1NopResponse.jsx";
import LoaderBig from "~/components/LoaderBig.jsx";
function HeaderNoResponse() {
  const { productsInCart, allCarts, lengthCart, loadingCart } = useSelector(state => state.cart)
  ...
  return (
    <header className="mx-auto relative">
                      ...
                      (
                        allCarts?.length === 0 ?
                          <div className="w-[300px] h-[150px] flex flex-col justify-center items-center ">
                            ...
                            <span className="font-medium text-base text-shop_main">You dont have any product yet</span>
                          </div>
                          :
                          <div className="w-max rounded-md py-4">
                            ...
                            {allCarts?.slice(0, 5).map(a => {
                              const p = a.product
                              return (
                                <div key={p._id} className="flex px-4 py-2 hover:bg-slate-200 w-full items-center justify-start">
                                  ...
                                  <div className="font-normal ml-2 w-full flex justify-between items-center ">
                                    <span className="text-black mr-16">{p.name.length > 18 ? p.name.slice(0, 18) + ' ...' : p.name}</span>
      ...
      <div className="h-[60px] w-full">
        <div className={"bg-shop_main min-w-[1216px] h-[60px] w-full  " + (active ? "shadow-sm fixed top-0 left-0 z-40" : null)} >
            ...
            <div className=" min-h-[60px] flex items-center justify-between">
              ...
              <div className="flex gap-4 xl:gap-10 ">
                <div>
                  ...
                  {dropDown && <DropDownMenu setDropDown={setDropDown} categoriesData={categoriesData} />}
                </div>
...
export default HeaderNoResponse;